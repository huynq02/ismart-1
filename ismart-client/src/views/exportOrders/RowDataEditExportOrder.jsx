...
import EditRowDataExportOrder from "./EditRowDataExport";

const RowDataEditExportOrder = ({ data, index, deleteRowData, updateRowData }) => {
...
export default RowDataEditExportOrder