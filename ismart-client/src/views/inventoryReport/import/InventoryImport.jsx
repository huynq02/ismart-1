...
import { fetchInventoryImport } from '~/services/InventoryReport';
import { formatDate } from '~/validate';
import { getUserIdWarehouse } from "~/services/UserWarehouseServices";

const InventoryInport = () => {
            ...
            <div className="container" style={{ maxWidth: "1600px" }}>
                <div className="row justify-content-center">
                    <div className="col-sm-12">
                        <h2 style={{ color: '#3b3bf5', marginTop: '20px' }}>Báo cáo hàng nhập</h2>
                                    ...
                                    <>
                                        <Col md={2} className="px-md-1 d-flex align-items-center">
                                            <div className="input-group mb-3">
                                                <h6>Ngày bắt đầu</h6>
                                                <input type="date" className="datepickerCSS" id="datepickerStart" value={startDate} onChange={handleStartDate} />
                                            </div>
                                        </Col>
                                        ...
                                        <Col md={2} className="px-md-1">
                                            <div className="input-group mb-3">
                                                <h6>Ngày kết thúc</h6>
                                                <input type="date" className="datepickerCSS" id="datepickerEnd" value={endDate} onChange={handleEndDate} />
                                            </div>
                                        </Col>
                                    </>
                                )}
                                    ...
                                    {inventoryData && inventoryData.length > 0 &&
                                        inventoryData.map((i, index) => (
                                            <tr key={`inventory${index}`}>
                                                ...
                                                <td className="align-middle">{formatDate(i.transactionDate)}</td>
                                            </tr>
                                        ))}
                                </tbody>
                            </Table>
...
export default InventoryInport;
